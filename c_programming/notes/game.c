...
char word_list[][101] = {"milky", "zigzag", "foggy", "mummy", "jolly", "poppy", "giggle", "happily", "WSPEED", "sevens", "pumpkins", "kick", "chipmunk", "kabaddi", "clockwork", "WKAI", "juicy", "chuckled", "pyonyang", "vampires", "femboy", "plump", "chuck", "fully", "puff", "jacuzzi", "middle", "magnify", "black", "wolf", "punch", "publicly", "dumbbell", "hobby", "apply", "quack", "bluebell", "crazy", "block", "puppy", "quiz", "pick", "gulf", "lucky", "clock", "cyborg", "prickly", "clump", "skull", "buzzer", "goon", "skilful", "halloween", "puzzle", "symbol", "chef", "volleyball", "windmill", "lollipop", "pumpkin", "building", "yolk", "cloud", "wrongly", "blazing", "fury", "clumsy", "pluck", "awful", "church", "yacht", "furlough", "duck", "muddy", "padlock", "flag", "headache", "coccyx", "flapjack", "unhappy", "lifestyle", "globe", "bauble", "decided", "cycling", "awkward", "gypsy", "symbols", "hyperlink", "pebble", "club", "baby", "volume", "review", "puzzling", "quickly", "pudding", "daffodil", "vivarium", "maximum", "stick"};
